...
describe('DrawerService', () => {
	...
	// Mock BreakpointService to isolate DrawerService tests
	...
	describe.skip('effect subscription cleanup', () => {
	...
	describe.skip('integration with NavigationDrawerComponent', () => {
