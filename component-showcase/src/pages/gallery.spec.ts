...
describe('Gallery Page', () => {
  ...
  it('should include Stencil component section', () => {
    ...
    const stencilSection = Array.from(container.querySelectorAll('.component-section'))
      .find(section => section.querySelector('h2')?.textContent === 'Stencil Components');
  ...
  it('should include Native component section', () => {
    ...
    const nativeSection = Array.from(container.querySelectorAll('.component-section'))
      .find(section => section.querySelector('h2')?.textContent === 'Native Web Components');
  ...
  it('should include integration notes section', () => {
    ...
    const integrationCards = integrationSection?.querySelectorAll('.integration-card');
